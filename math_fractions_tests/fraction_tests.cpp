...
namespace creating_fractions
{
	...
	public:
		...
		TEST_METHOD(fraction_with_zero_denominator)
		{
			Assert::ExpectException<std::exception>([] {fraction(5, 0); });
		}
...
namespace fraction_comparison
{
	...
	public:
		...
		{
			auto f = fraction(9, 18);
			auto f2 = fraction(6, 8);
			Assert::IsFalse(f == f2);
			Assert::IsTrue(f != f2);
		}
		...
		{
			auto f = fraction(-6, 18);
			auto f2 = fraction(6, -12);
			Assert::IsFalse(f == f2);
			Assert::IsTrue(f != f2);
		}
...
namespace fraction_arithmetic
{
	...
	public:
		...
		{
			auto f = fraction(3, 4);
			auto f2 = fraction(5, 8);
			auto expected = fraction(11, 8);
